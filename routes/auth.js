...
router.get('/profile', authMiddleware, authController.getProfile); // Universal profile endpoint
router.put('/profile', authMiddleware, authController.updateProfile); // Universal profile update endpoint
